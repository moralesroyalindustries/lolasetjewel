                          ...
                          <div className="p-3">
                            ...
                            <div className="flex gap-1">
                              ...
                              <button
                                ...
                                className="flex items-center justify-center text-xs font-body text-red-400 hover:text-red-600 hover:bg-red-50 transition-colors px-2 py-1.5 border border-cream-200 hover:border-red-200"
                              >
                                <Trash2 size={11} />
                              </button>
                            </div>
                            ...
                            {confirmDelete === product.id && (
                              <div className="mt-2 p-3 bg-red-50 border border-red-200 text-center">
                                <p className="font-body text-xs text-red-700 mb-2">¿Borrar este producto permanentemente?</p>
                                <div className="flex gap-2">
                                  <button
                                    onClick={() => deleteProduct(product.id)}
                                    className="flex-1 bg-red-500 text-white text-xs font-body py-1.5 hover:bg-red-600 transition-colors"
                                  >
                                    Sí, borrar
                                  </button>
                                  <button
                                    onClick={() => setConfirmDelete(null)}
                                    className="flex-1 border border-cream-300 text-onyx-600 text-xs font-body py-1.5 hover:bg-cream-100 transition-colors"
                                  >
                                    Cancelar
                                  </button>
                                </div>
